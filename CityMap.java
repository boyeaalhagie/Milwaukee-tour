...
public class CityMap extends Application {
    ...
    private void addEntities() {
        ...
        challengesSubject.attach(new MSOEChallenge("MSOE"));
        challengesSubject.attach(new MuseumChallenge(painting));
        challengesSubject.attach(new EasterEggChallenge("BUS"));
    }
}
